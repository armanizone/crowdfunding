  ...
  return (
    <div className='flex justify-between mb-3 bg-white border p-3 md:p-4'>
      <div className='flex items-center gap-3 md:gap-4'>
        <img
          src={'https://s7.planeta.ru/p?url=https%3A%2F%2Fstatic.planeta.ru%2Fimages%2Favatars%2Fava-u-03.jpg&width=150&height=150&crop=true&pad=false&disableAnimatedGif=true'}
          alt=""
          className='w-12 shadow-lg shadow-sky-100'
        />
        <div>
          <b className='text-sm md:text-base'>{'sasageyo'}</b>
          <p>
